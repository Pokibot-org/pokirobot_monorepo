"""Eurobot 2026 competition config.

To add a new year: copy this folder, rename to `eurobot_<year>`, drop new
assets into `img/`, and tweak the numbers below + `actions.py` as needed."""
