...
typedef int (*pokstepper_api_set_speed)(const struct device *dev, int32_t speed_msps);
...
typedef int (*pokstepper_api_move_by)(const struct device *dev, uint32_t speed_msps, int32_t steps);
typedef int (*pokstepper_api_move_to)(const struct device *dev, uint32_t speed_msps, int32_t steps);
typedef int (*pokstepper_api_go_to_stall)(const struct device *dev, uint32_t speed_msps,
...
static inline int pokstepper_set_speed(const struct device *dev, int32_t speed_msps)
{
    const struct pokstepper_driver_api *api = (const struct pokstepper_driver_api *)dev->api;
    ...
    return api->set_speed(dev, speed_msps);
}
...
static inline int pokstepper_move_by(const struct device *dev, uint32_t speed_msps, int32_t steps)
{
    const struct pokstepper_driver_api *api = (const struct pokstepper_driver_api *)dev->api;
    ...
    return api->move_by(dev, speed_msps, steps);
}

static inline int pokstepper_move_to(const struct device *dev, uint32_t speed_msps, int32_t steps)
{
    const struct pokstepper_driver_api *api = (const struct pokstepper_driver_api *)dev->api;
    ...
    return api->move_to(dev, speed_msps, steps);
}

static inline int pokstepper_go_to_stall(const struct device *dev, uint32_t speed_msps,
                                         int32_t steps, uint8_t detection_threshold)
{
    const struct pokstepper_driver_api *api = (const struct pokstepper_driver_api *)dev->api;
    ...
    return api->go_to_stall(dev, speed_msps, steps, detection_threshold);
}
